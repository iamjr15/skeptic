...
//   node scripts/gen-sea-config.mjs --base /path/to/cli --output /path/to/binary --executable /path/to/node
...
const executablePath = args.executable ? resolve(args.executable) : undefined;
...
const config = {
  main: join(distDir, "skeptic-sea.cjs"),
  output: outputPath,
