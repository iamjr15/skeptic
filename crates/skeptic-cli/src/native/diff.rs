...
pub fn diff_screenshot(
    ...
    // Pixelmatch's YIQ perceptual color delta. This weighs luminance more
    // heavily than chroma and avoids flagging many invisible RGB changes.
    let max_color_distance = threshold * threshold * 35_215.0;
    ...
    for y in 0..ha {
        for x in 0..wa {
            ...
            let delta_y = 0.298_895_31 * dr + 0.586_622_47 * dg + 0.114_482_23 * db;
            let delta_i = 0.595_977_99 * dr - 0.274_176_10 * dg - 0.321_801_89 * db;
            let delta_q = 0.211_470_17 * dr - 0.522_617_11 * dg + 0.311_146_94 * db;
            let dist =
                0.5053 * delta_y * delta_y + 0.299 * delta_i * delta_i + 0.1957 * delta_q * delta_q;
